...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    iconClasses: function iconClasses() {
      return this.iconSmall ? 'w-3 mr-2 mb-1' : 'w-5 mr-2 mb-1';
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    navbarColor: function navbarColor() {
      var color = "linear-gradient(to right, #142144 , #1A2144)";
      if (this.navbarType === "sticky") color = "linear-gradient(to right, #142144 , #1A2144)";else if (this.navbarType === 'static') {
        if (this.scrollY < 50) {
...
// module
exports.push([module.i, ".icon-after {\n  top: 12px;\n}[dir] .icon-after {\n  border: none !important;\n}", ""]);
          ...
          [
            _c(
              "ul",
              {
                ...
                staticStyle: { "place-content": "center", "font-size": ".8rem" }
              },
                  ...
                  [
                    item.header
                      ...
                      ? [
                          _c("h-nav-menu-group", {
                            key: "group-" + index,
                            staticClass: "menu-group relative pt-4 pb-2",
                            attrs: {
                              bottom: "",
                              group: item,
                              groupIndex: index,
                      ...
                      ? _c(
                          ...
                          [
                            _c(
                              ...
                              {
                                staticClass:
                                  "relative pt-6 pb-3 cursor-pointer mx-3",
                                attrs: {
                                  to:
        ...
        _c(
          ...
          [
            _c(
              "div",
              {
                staticClass: "vx-row no-gutter items-center",
                ...
                _c(
                  ...
                  [
                    _c(
                      "router-link",
                      {
                        staticClass: "vx-logo cursor-pointer mr-auto",
                        attrs: { tag: "div", to: "/" }
                      },
                      [
                        _c("img", {
...
var render = function() {
  ...
  return _vm.activeUserInfo.displayName
    ? _c(
        "div",
        { staticClass: "the-navbar__user-meta flex items-center float-right" },
        [
          _c(
            "div",
            { staticClass: "text-right leading-tight hidden sm:block" },
            [
              _c("span", { staticClass: "font-light" }, [_vm._v("Olá, ")]),
              _vm._v(" "),
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_sass_loader_dist_cjs_js_ref_8_3_node_modules_vue_loader_lib_index_js_vue_loader_options_TheNavbarHorizontal_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_sass_loader_dist_cjs_js_ref_8_3_node_modules_vue_loader_lib_index_js_vue_loader_options_TheNavbarHorizontal_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_sass_loader_dist_cjs_js_ref_8_3_node_modules_vue_loader_lib_index_js_vue_loader_options_TheNavbarHorizontal_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
