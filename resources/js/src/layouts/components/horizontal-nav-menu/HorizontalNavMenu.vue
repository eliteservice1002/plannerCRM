  ...
  <div class="relative">
    <div class="vx-navbar-wrapper nav-menu-wrapper">
      <vs-navbar class="vx-navbar navbar-custom navbar-skelton" :color="navbarColor">
        ...
        <ul class="menu-items flex flex-wrap w-full items-center" style="place-content:center;font-size:.8rem;">
          <li
            class  = "menu-item"
            ...
            <template v-else-if="item.submenu">
              <h-nav-menu-group
                class="menu-group relative pt-4 pb-2"
                bottom
                :key        ="`group-${index}`"
                :group      ="item"
                :groupIndex ="index"
            ...
            <div v-else-if="item.url" class="menu-link">
              <h-nav-menu-item
                class       = "relative pt-6 pb-3 cursor-pointer mx-3"
